...
class Session extends React.Component{
    ...
    componentWillMount(){
        GetGetSessionData("http://localhost:3333/api/method/GetResult","http://localhost:3333/api/method/GetFutureResult",this.state.sessionid,this.updateSessionData,this);   
    }
